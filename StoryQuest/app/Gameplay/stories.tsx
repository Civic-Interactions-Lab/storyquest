  ...
  words: {
    [word: string]: {
      ...
      effect?:
        ...
        | "scaleUp"
        | "none"
        | "SlideAcrossEffect"; // Add effect property
...
const stories: Story[] = [
    ...
    sections: [
      {
        ...
        words: {
          ...
          star: { image: "star.svg", x: 40, y: 5, effect: "pulse" },
  ...
  // NEW STORY - NUMBER 3
  {
    ...
    sections: [
      {
        phrase: "We are travelling through space and saw a ___.",
        words: {
          planet: { image: "planet.svg", x: 80, y: 5, effect: "spin" },
          comet: { image: "comet.svg", x: 80, y: 5, effect: "sideToSide" },
          sun: { image: "sun.svg", x: 80, y: 5, effect: "bounce" },
          car: { image: "car.svg", x: 80, y: 5, effect: "flip" },
          robot: { image: "robot.svg", x: 80, y: 5, effect: "fade" },
...

      {
        ...
        words: {
          wizard: { image: "wizard.svg", x: 50, y: 50, effect: "scaleUp" },
          book: { image: "book.svg", x: 50, y: 50, effect: "fade" },
          rocket: { image: "rocket.svg", x: 50, y: 50, effect: "upAndDown" },
          robot: { image: "robot.svg", x: 50, y: 50, effect: "scaleUp" },
          shootingStar: {
            image: "shootingstar.svg",
            x: 50,
            y: 50,
            effect: "sideToSide",
          },
      ...
      {
        phrase: "Under the moon, we spotted a ___.",
        words: {
          spaceDog: { image: "spacedog.svg", x: 15, y: 80, effect: "bounce" },
          star: { image: "star.svg", x: 15, y: 80, effect: "none" },
      ...
      {
        phrase: "Space is a place full of ___.",
        words: {
          stars: { image: "star.svg", x: 90, y: 60, effect: "bounce" },
          stones: { image: "stones.svg", x: 90, y: 60, effect: "none" },
          feathers: { image: "feathers.svg", x: 90, y: 60, effect: "spin" },
          books: { image: "book.svg", x: 90, y: 60, effect: "pulse" },
          planets: { image: "planet.svg", x: 90, y: 60, effect: "pulse" },
          UFOs: { image: "ufo.svg", x: 90, y: 60, effect: "fade" },
        },
      },

      {
        ...
        words: {
          ...
          wizard: { image: "wizard.svg", x: 90, y: 90, effect: "scaleUp" },
      ...
      {
        phrase: "We also said hello to a ___.",
        words: {
          witch: { image: "witch.svg", x: 5, y: 90, effect: "pulse" },
      ...
      {
        phrase: "We asked for directions from a ___.",
        words: {
          witch: { image: "witch.svg", x: 60, y: 90, effect: "pulse" },
  ...
  // NEW STORY - NUMBER 4
  {
    ...
    sections: [
      {
        phrase:
          "It is a beautiful day under the ocean, on our right we see a ___.",
        words: {
          bluefish: { image: "bluefish.svg", x: 80, y: 40, effect: "scaleUp" },
          redfish: { image: "redfish.svg", x: 80, y: 40, effect: "sideToSide" },
          shark: { image: "shark.svg", x: 80, y: 40, effect: "sideToSide" },
      ...
      },
      {
        ...
        words: {
          ...
          shark: { image: "shark.svg", x: 10, y: 30, effect: "bounce" },
...

      {
        ...
        words: {
          ...
          shark: { image: "shark.svg", x: 40, y: 99, effect: "bounce" },
...

      {
        ...
        words: {
          ...
          shark: { image: "shark.svg", x: 70, y: 50, effect: "bounce" },
...

      {
        ...
        words: {
          ...
          submarine: { image: "submarine.svg", x: 80, y: 0, effect: "bounce" },
...

      {
        ...
        words: {
          ...
          redfish: { image: "redfish.svg", x: 10, y: 20, effect: "bounce" },
